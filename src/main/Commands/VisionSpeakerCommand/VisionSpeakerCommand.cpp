...
void VisionSpeakerCommand::Execute() {
	...
	units::degree_t headingTolerance = 2_deg + units::degree_t(std::clamp(1 - distance.value() / 6.0, 0.0, 1.0) * 10.0); // Heading tolerance extra of X deg when close, more precise when further back;
