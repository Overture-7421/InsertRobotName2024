...
SuperStructureState superStructureStartingState{ -15_deg, -60_deg };
SuperStructureState superStructureTargetState{ 85_deg, -80_deg };
...
frc2::CommandPtr ClimbAtLocation(SuperStructure* superStructure, Shooter* shooter, Storage* storage, frc::XboxController* controller) {
	return frc2::cmd::Sequence(
		...
		WaitForButton(controller, checkpointButtonId),
		superStructure->superStructureCommand({ 93_deg, -77_deg }).WithTimeout(1_s), // 87 arm
