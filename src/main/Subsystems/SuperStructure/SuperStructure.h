...
private:
	...
	frc::ProfiledPIDController<units::degrees> lowerPID{ 0.25, 0.8, 0.0, {360_deg_per_s * 4.0, 360_deg_per_s_sq * 1.25}, RobotConstants::LoopTime };
