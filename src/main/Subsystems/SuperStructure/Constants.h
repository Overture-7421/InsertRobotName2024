...
namespace SuperStructureConstants {
    ...
    const static double LowerAngleLowerLimit = -28;
    ...
    const static SuperStructureState GroundGrabState = {-29.8, 0};
    const static SuperStructureState SourceGrabState = { -29.8, 0.0 };
