...
private:
	...
	frc::SimpleMotorFeedforward<units::turn> upperFF {0.26005_V, 0.050_V / 1_tps, 0.015494_V / 1_tr_per_s_sq};
	frc::SimpleMotorFeedforward<units::turn> lowerFF {0.29464_V, 0.050_V / 1_tps, 0.015067_V / 1_tr_per_s_sq};
	double targetVel;
	double lastTime = 0.0;
