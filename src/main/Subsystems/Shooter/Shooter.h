...
private:
	...
	frc::SimpleMotorFeedforward<units::turn> upperFF {0.4_V, 0_V / 1_tps, 0_V / 1_tr_per_s_sq};
	frc::SimpleMotorFeedforward<units::turn> lowerFF {0.4_V, 0_V / 1_tps, 0_V / 1_tr_per_s_sq};
