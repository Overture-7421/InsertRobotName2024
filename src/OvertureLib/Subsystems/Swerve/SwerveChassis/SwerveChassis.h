...
private:
	...
	frc::ProfiledPIDController<units::radians> headingController{ 11.0, 0.5, 0.2, frc::TrapezoidProfile<units::radians>::Constraints{ 18_rad_per_s, 18_rad_per_s_sq * 6 }, RobotConstants::LoopTime };
